    ...
    function cargarProductos(filtro) {
      ...
      switch (filtro) {
        ...
        case "eligiendo":
          ...
          let segundo = sessionStorage.getItem("segundo");
          let tercero = sessionStorage.getItem("tercero");
          let cuarto = sessionStorage.getItem("cuarto");
          var productosFiltrados = []
          
          let a =  productos.find(a => a.id == primero)
          let b =  productos.find(a => a.id == segundo)
          let c =  productos.find(a => a.id == tercero)
          let d =  productos.find(a => a.id == cuarto)
          productosFiltrados.push(a)
          productosFiltrados.push(b)
          productosFiltrados.push(c)
          productosFiltrados.push(d)
          break;
        default:
